...
class AppColors {
  ...
  static const Color lightBlueColor = Color(0xffC9F0FF);
  ...
  static const Color grey = Color(0xFFF3F2F2);
  // Gradient colors
  ...
  static const Color containerColor2 = Color(0xFFF4F4F4);
  static const Color borderColor = Color(0xffCFCFCF);

  static const Color buttonColor2 = Color(0x33CBA033);
